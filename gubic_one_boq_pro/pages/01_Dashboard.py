...
from modules.ui_helpers import inject_css, page_header, kpi_card, require_data, filter_dataframe, render_insight_panel
...
render_insight_panel(executive_insights(filtered))
