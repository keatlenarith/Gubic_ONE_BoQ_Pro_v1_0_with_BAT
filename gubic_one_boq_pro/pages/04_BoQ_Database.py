...
from modules.ui_helpers import inject_css, page_header, require_data, filter_dataframe, download_dataframe_button, kpi_card, fit_dataframe
...
fit_dataframe(filtered, use_container_width=True, height=650)
