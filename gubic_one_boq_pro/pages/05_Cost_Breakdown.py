...
st.set_page_config(page_title="Cost Breakdown - Gubic ONE BoQ Pro", layout="wide")
inject_css()
page_header("Cost Breakdown", "Analyze cost types, package rankings, sections, top items, and validation issues.")
...
tabs = st.tabs(["Cost Type", "Package Ranking", "Section Ranking", "Top Items", "Validation"])
