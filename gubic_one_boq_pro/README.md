...
## v1.2.3 Sidebar Menu Icon Patch
...
## v1.2.3 Khmer Text Layout Patch

The v1.2.3 patch improves Khmer font rendering and prevents text overlap in headers, file uploader controls, radio buttons, expanders, tables, and buttons.
